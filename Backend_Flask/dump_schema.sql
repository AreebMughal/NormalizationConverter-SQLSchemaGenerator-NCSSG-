...
CREATE DATABASE `NCSSG_dumped_db_gf26`;

-- 
-- Table structure for table `dataset` 
-- 

CREATE TABLE `NCSSG_dumped_db_gf26`.`dataset` ( 
	`ssn` int(11) NOT NULL 
...
CREATE TABLE `NCSSG_dumped_db_gf26`.`dat_id` ( 
	`id` int(11) NOT NULL, 
...
CREATE TABLE `NCSSG_dumped_db_gf26`.`dat_name` ( 
	`Name` int(11) NOT NULL, 
 	`id` int(11) NOT NULL 
 ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `NCSSG_dumped_db_gf26`.`dat_name_1` ( 
	`Name` int(11) NOT NULL, 
 	`ssn` int(11) NOT NULL 
 ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
-- 
ALTER TABLE `NCSSG_dumped_db_gf26`.`dataset`
	ADD PRIMARY KEY (`ssn`);

-- 
-- Indexes for table `dat_id` 
-- 
ALTER TABLE `NCSSG_dumped_db_gf26`.`dat_id`
	ADD PRIMARY KEY (`id`),
...
-- 
ALTER TABLE `NCSSG_dumped_db_gf26`.`dat_name`
...
-- 
ALTER TABLE `NCSSG_dumped_db_gf26`.`dat_name_1`
	ADD PRIMARY KEY (`Name`),
