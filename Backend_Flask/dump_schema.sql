...
CREATE DATABASE `NCSSG_dumped_db_qr08`;

-- 
-- Table structure for table `practice` 
-- 

CREATE TABLE `NCSSG_dumped_db_qr08`.`practice` ( 
...
CREATE TABLE `NCSSG_dumped_db_qr08`.`pra_ssn` ( 
	`ssn` int(11) NOT NULL, 
 	`id` int(11) NOT NULL 
 ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `NCSSG_dumped_db_qr08`.`pra_pnum` ( 
	`pnum` int(11) NOT NULL, 
...
CREATE TABLE `NCSSG_dumped_db_qr08`.`pra_email` ( 
	`pnum` int(11) NOT NULL, 
 	`ssn` int(11) NOT NULL, 
...
CREATE TABLE `NCSSG_dumped_db_qr08`.`pra_address` ( 
	`ssn` int(11) NOT NULL, 
...
CREATE TABLE `NCSSG_dumped_db_qr08`.`pra_id` ( 
	`id` int(11) NOT NULL, 
...
CREATE TABLE `NCSSG_dumped_db_qr08`.`pra_dnum` ( 
	`dnum` int(11) NOT NULL, 
...
-- 
ALTER TABLE `NCSSG_dumped_db_qr08`.`practice`
	ADD PRIMARY KEY (`pnum`,`ssn`);

-- 
-- Indexes for table `pra_ssn` 
-- 
ALTER TABLE `NCSSG_dumped_db_qr08`.`pra_ssn`
	ADD PRIMARY KEY (`ssn`),
...
-- 
ALTER TABLE `NCSSG_dumped_db_qr08`.`pra_pnum`
	ADD PRIMARY KEY (`pnum`);

-- 
-- Indexes for table `pra_email` 
-- 
ALTER TABLE `NCSSG_dumped_db_qr08`.`pra_email`
	ADD PRIMARY KEY (`pnum`,`ssn`,`email`);

-- 
-- Indexes for table `pra_address` 
-- 
ALTER TABLE `NCSSG_dumped_db_qr08`.`pra_address`
	ADD PRIMARY KEY (`ssn`,`address`);

-- 
-- Indexes for table `pra_id` 
-- 
ALTER TABLE `NCSSG_dumped_db_qr08`.`pra_id`
	ADD PRIMARY KEY (`id`),
...
-- 
ALTER TABLE `NCSSG_dumped_db_qr08`.`pra_dnum`
