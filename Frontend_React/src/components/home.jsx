                        ...
                        <div className='ms-5 mb-5 usage2'>
                            ...
                            <div className="intro-body">
                                <p className=''>
                                    ...
                                    DB engineers can now use this tool to speed up their process of making DB
                                    architecture
                                    by normalizing it.
                                </p>
                            </div>
                    ...
                    <div className="col-lg-6">
                        <div className="usage ms-5">
                            ...
                            <div className="usage-body ">
                                <p className=''>
                                    This tool provides you with two choices of entering your data. You may upload your
                                    File
                                    or use toolBox to get started with this tool. After setting your constraints you can
                                    click on your desired level of Normalization form till BCNF. You can also generate
                                    SQL
